...
{
    public class PathNaturalStringComparerTests
    {
        [Theory]
        ...
        {
            var result = new PathNaturalStringComparer(comparison).Compare(left, right);

            result.Should().Be(expected);
        }

        [Fact]
        public void Linq_OrderBy_using_PathNaturalStringComparer_orders_items_using_natural_sorting()
        {
            var input = new[]
            {
                "Folder 3",
            ...
            var output = input.OrderBy(s => s, new PathNaturalStringComparer()).ToArray();
        ...
        [SkippableFact]
        public void PathNaturalStringComparer_OrdinalIgnoreCase_behaves_like_Windows_StrCmpLogicalW_API()
        {
        ...
        public void Can_sort_array_of_string_using_natural_sorting()
        {
            ...
            Array.Sort(input, PathNaturalStringComparer.OrdinalIgnoreCase);
        ...
        {
            var sortedDictionary = new SortedDictionary<string, object?>(PathNaturalStringComparer.Ordinal);
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.IsLessThan(left, right);
            result.Should().Be(expected);
        }
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.IsLessThanOrEqual(left, right);
            result.Should().Be(expected);
        }
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.IsEqual(left, right);
            result.Should().Be(expected);
        }
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.IsGreaterThan(left, right);
            result.Should().Be(expected);
        }
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.IsGreaterThanOrEqual(left, right);
            result.Should().Be(expected);
        }
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.Compare(left, right);
            result.Should().Be(expected);
        }
        ...
        {
            var result = PathNaturalStringComparer.OrdinalIgnoreCase.Equals(left, right);
            result.Should().Be(expected);
        }
        ...
        public void GetHashCode_uses_natural_string_comparison(string value)
        {
            ...
            var result = PathNaturalStringComparer.Ordinal.GetHashCode(value);
            result.Should().Be(expected);
        }
        ...
        {
            PathNaturalStringComparer.Ordinal.Should().NotBeNull()
                .And.BeOfType<PathNaturalStringComparer>();

            PathNaturalStringComparer.OrdinalIgnoreCase.Should().NotBeNull()
                .And.BeOfType<PathNaturalStringComparer>();

            PathNaturalStringComparer.InvariantCulture.Should().NotBeNull()
                .And.BeOfType<PathNaturalStringComparer>();

            PathNaturalStringComparer.InvariantCultureIgnoreCase.Should().NotBeNull()
                .And.BeOfType<PathNaturalStringComparer>();

            PathNaturalStringComparer.CurrentCulture.Should().NotBeNull()
                .And.BeOfType<PathNaturalStringComparer>();

            PathNaturalStringComparer.CurrentCultureIgnoreCase.Should().NotBeNull()
                .And.BeOfType<PathNaturalStringComparer>();
        }
