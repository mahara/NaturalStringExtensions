...
namespace System
{
    ...
    public class PathNaturalStringComparer : INaturalStringComparer
    {
        ...
        public int Compare(object? x, object? y)
        {
            ...
            if (leftAsString is not null || x is null)
            {
                var rightAsString = y as string;
                if (rightAsString is not null || y is null)
                {
        ...
        private static StringSegmentEnumerator GetSegments(string value) => new(value);
        ...
        private struct StringSegmentEnumerator
        {
            ...
            public readonly ReadOnlySpan<char> Current => _value.AsSpan(_start, _length);
